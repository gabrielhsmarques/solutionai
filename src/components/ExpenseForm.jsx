...
export default function ExpenseForm() {
  ...
  return (
    <div className="bg-surface border border-border rounded-xl p-5 shadow-card mb-4">
      <h2 className="text-base font-semibold text-text mb-4">New Expense</h2>
      ...
      <button
        ...
        className="w-full py-3 text-[15px] font-medium bg-primary text-black rounded-lg hover:bg-primary-dark transition-colors"
      >
        Save Expense
      </button>
    </div>
